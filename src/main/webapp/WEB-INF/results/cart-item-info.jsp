...
<div class="main-container">
  ...
  <div id="catalog-container">
    ...
    <div class="product-details-container">
      <p class="section-title">Info Prodotto:</p>
      ...
      <p class="info-text"><span class="info-header">Descrizione:</span> <span class="info-text-long">${requestScope.product.getDescription()}</span></p>
